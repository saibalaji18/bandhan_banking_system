  ...
  ?>
    ...
    <div class="container-fluid">
        ...
        <div class="intro py-1">
            <div >
                <div >
                   <center> <h1>Welcome to Bandhan Banking System</h1></center>
                </div>
            </div>
        ...
        <div class="row activity text-center">
            ...
            <div class="col-md act">
                ...
                <br><br>
                <a href="viewallusers.php"><button>View all Users</button></a>
            </div>
            <div class="col-md act">
                <br><br><br>
    ...
    <footer class="text-center mt-5 py-2">
        <p>&copy 2021. Made by <b>Sai Balaji</b> <br> For the Project of  <b>The Sparks Foundation</b></p>
    </footer>
